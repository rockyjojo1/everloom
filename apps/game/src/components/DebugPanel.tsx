...
export function DebugPanel() {
  ...
  return <details className="debug"><summary>Debug</summary>
    ...
    <button onClick={() => store.debugAddItem("copper_ore", 6)}>+ copper ore ×6</button>
    ...
    <button onClick={() => store.debugCompleteQuest("forge_trade")}>Force-complete Forge's Trade</button>
